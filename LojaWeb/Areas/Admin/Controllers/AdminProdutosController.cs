...
namespace LojaWeb.Areas.Admin.Controllers
{
    ...
    public class AdminProdutosController : Controller
    {
        ...
        public AdminProdutosController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemThumbNail,IsProdutosPreferidos,EmEstoque,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemThumbNail,IsProdutosPreferidos,EmEstoque,CategoriaId")] Produto produto)
        {
